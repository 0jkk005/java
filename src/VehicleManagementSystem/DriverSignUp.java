...
public class DriverSignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        checkJeep = new javax.swing.JCheckBox();
        ...
        checkCar.setBounds(190, 270, 80, 21);

        checkJeep.setBackground(new java.awt.Color(255, 255, 255));
        checkJeep.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        checkJeep.setForeground(new java.awt.Color(204, 204, 204));
        checkJeep.setText("Jeep");
        checkJeep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                checkJeepActionPerformed(evt);
            }
        });
        kGradientPanel1.add(checkJeep);
        checkJeep.setBounds(300, 270, 100, 21);
        ...
        checkBus.setBounds(440, 270, 90, 21);
    ...
    private void checkJeepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkJeepActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_checkJeepActionPerformed
...
else if(checkJeep.isSelected())
{
    
    DriverJeep driver=new DriverJeep(name,fname,age,gender,sec,user,pass,"Jeep",cnic,contactNo,dob);
        driver.addDriver();
        type=checkJeep.getText();
    Jeep jeep=new Jeep();
   int result;
    result = jeep.assignJeep();
    String model=jeep.getRModel(result);
    String version=jeep.getRVersion(result);
    String color=jeep.getRColor(result);
    String plateNo=jeep.getRPlateNo(result);
    String rDate=jeep.getRRDate(result);
    String eDate=jeep.getEDate(result);
    String carName=jeep.getJeepName(result);
    showModel.setText(model);
    showVersion.setText(version);
    showColor.setText(color);
    showPlateNo.setText(plateNo);
    ...
    showEDate.setText(eDate);
    showCarName.setText(carName);
    DriverJeep dd=new DriverJeep();
    dd.insertDriverJeepData(user,name,type,plateNo,result,carName);
}
    ...
    private javax.swing.JCheckBox checkJeep;
