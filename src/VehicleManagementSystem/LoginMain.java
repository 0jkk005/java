...
public class LoginMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LoginAsCombo.setBounds(910, 260, 110, 22);
        ...
        SignUpButton.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, -1, 20));
        ...
        jLabel5.setBounds(1090, 660, 200, 16);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(kGradientPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 1301, Short.MAX_VALUE))
        );
        ...
        else
        {
            ...
            else if(LoginAs.equals("Driver"))
            {
                ...
                if(checking.chkDriverPass(iidd, pass))
                {
                    ...
                    else if(answer.equals("Jeep"))
                    {
                        DriverJeep dr=new DriverJeep();
                        String dname=dr.getRDriverName(iidd);
                        int carid=dr.getRJeepId(iidd);
                        String carName=dr.getRJeepName(iidd);
                        String plateNo=dr.getRJeepPlate(iidd);
                        String type="Jeep";
                        DriverHome dh=new DriverHome(iidd,dname,type,plateNo,carid,carName);
                        this.setVisible(false);
